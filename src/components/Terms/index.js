...
export default function Terms(){
    return <><div style={{margin: '20px'}}>
        <Typography variant="h5">Website Terms of Use</Typography>

<Typography>Version 1.0</Typography>

<Typography>The Kofas Tools website located at https://kofastools.com is a copyrighted work belonging to Kofas Tools. Certain
    features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site
    in connection with such features.</Typography>

<Typography>All such additional terms, guidelines, and rules are incorporated by reference into these Terms.</Typography>

<Typography>These Terms of Use described the legally binding terms and conditions that oversee your use of the Site. BY
    LOGGING INTO THE SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and you represent that you have the authority
    and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS OF AGE TO ACCESS THE SITE. IF YOU
    DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.<Typography>

        <Typography>These terms require the use of arbitration Section 10.2 on an individual basis to resolve disputes and
            also limit the remedies available to you in the event of a dispute. These Terms of Use were created with
            the help of the <Link to="https://www.termsofusegenerator.net">Terms Of Use Generator</Link> and the <Link
                to="https://www.privacy-policy-sample.com">Privacy Policy Sample</Link>.</Typography>


        <Typography variant="h5">Access to the Site</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Subject to these Terms.</Typography> Company grants you a non-transferable, non-exclusive, revocable,
            limited license to access the Site solely for your own personal, noncommercial use.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Certain Restrictions.</Typography> The rights approved to you in these Terms are subject to the
            ...
            proprietary notices on the Site must be retained on all copies thereof.</Typography>

        <Typography>Company reserves the right to change, suspend, or cease the Site with or without notice to you.  You
            approved that Company will not be held liable to you or any third-party for any change, interruption, or
            termination of the Site or any part.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>No Support or Maintenance.</Typography> You agree that Company will have no obligation to provide you
            with any support in connection with the Site.</Typography>

        <Typography>Excluding any User Content that you may provide, you are aware that all the intellectual property rights,
            ...
            expressed in Section 2.1. Company and its suppliers reserve all rights not granted in these Terms.</Typography>

        <Typography variant="h5">User Content</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>User Content.</Typography> "User Content" means any and all information and content that a user
            ...
            way provided, sponsored or endorsed by Company. Because you alone are responsible for your User Content,
            you may expose yourself to liability. Company is not obliged to backup any User Content that you post;
            also, your User Content may be deleted at any time without prior notice to you. You are solely
            responsible for making your own backup copies of your User Content if you desire.</Typography>

        <Typography>You hereby grant to Company an irreversible, nonexclusive, royalty-free and fully paid, worldwide license
            to reproduce, distribute, publicly display and perform, prepare derivative works of, incorporate into
            other works, and otherwise use and exploit your User Content, and to grant sublicenses of the foregoing
            rights, solely for the purposes of including your User Content in the Site.  You hereby irreversibly
            waive any claims and assertions of moral rights or attribution with respect to your User Content.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Acceptable Use Policy.</Typography> The following terms constitute our "Acceptable Use Policy":
            You agree not to use the Site to collect, upload, transmit, display, or distribute any User Content (i)
            that violates any third-party right or any intellectual property or proprietary right; (ii) that is
            ...
            obligations or restrictions imposed by any third party.</Typography>

        <Typography>In addition, you agree not to: (i) upload, transmit, or distribute to or through the Site any software
            ...
            other form of duplicative or unsolicited messages; (iii) use the Site to harvest, collect, gather or
            assemble information or data regarding other users without their consent; (iv) interfere with, disrupt,
            or create an undue burden on servers or networks connected to the Site, or violate the regulations,
            policies or procedures of such networks; (v) attempt to gain unauthorized access to the Site, whether
            ...
            on the Site, or to generate automated searches, requests, or queries to the Site.</Typography>

        <Typography>We reserve the right to review any User Content, and to investigate and/or take appropriate action
            against you in our sole discretion if you violate the Acceptable Use Policy or any other provision of
            these Terms or otherwise create liability for us or any other person. Such action may include removing
            or modifying your User Content, terminating your Account in accordance with Section 8, and/or reporting
            you to law enforcement authorities.</Typography>

        <Typography>If you provide Company with any feedback or suggestions regarding the Site, you hereby assign to Company
            all rights in such Feedback and agree that Company shall have the right to use and fully exploit such
            Feedback and related information in any manner it believes appropriate.  Company will treat any Feedback
            you provide to Company as non-confidential and non-proprietary.</Typography>

        <Typography>You agree to indemnify and hold Company and its officers, employees, and agents harmless, including costs
            and attorneys’ fees, from any claim or demand made by any third-party due to or arising out of (a) your
            use of the Site, (b) your violation of these Terms, (c) your violation of applicable laws or regulations
            or (d) your User Content.  Company reserves the right to assume the exclusive defense and control of any
            matter for which you are required to indemnify us, and you agree to cooperate with our defense of these
            claims.  You agree not to settle any matter without the prior written consent of Company.  Company will
            use reasonable efforts to notify you of any such claim, action or proceeding upon becoming aware of it.
        </Typography>

        <Typography variant="h5">Third-Party Links & Ads; Other Users</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Third-Party Links & Ads.</Typography> The Site may contain links to third-party websites and
            ...
            party’s terms and policies apply, including the third party’s privacy and data gathering practices.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Other Users.</Typography> Each Site user is solely responsible for any and all of its own User
            ...
            dispute between you and any Site user, we are under no obligation to become involved.</Typography>

        <Typography>You hereby release and forever discharge the Company and our officers, employees, agents, successors, and
            ...
            which if known by him or her must have materially affected his or her settlement with the debtor."</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Cookies and Web Beacons.</Typography> Like any other website, Kofas Tools uses ‘cookies’. These
            cookies are used to store information including visitors’ preferences, and the pages on the website that
            the visitor accessed or visited. The information is used to optimize the users’ experience by
            customizing our web page content based on visitors’ browser type and/or other information.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Google DoubleClick DART Cookie.</Typography> Google is one of a third-party vendor on our site. It
            also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to
            www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART
            cookies by visiting the Google ad and content network Privacy Policy at the following URL – <Link 
            to="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</Link>
        </Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Our Advertising Partners.</Typography> Some of advertisers on our site may use cookies and web
            beacons. Our advertising partners are listed below. Each of our advertising partners has their own
            Privacy Policy for their policies on user data. For easier access, we hyperlinked to their Privacy
            Policies below.</Typography>

        <ul>
            <li>
                <Typography>Google</Typography>
                <Typography><Link to="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</Link>
                </Typography>
            </li>
        </ul>
        ...
        <Typography>The site is provided on an "as-is" and "as available" basis, and company and our suppliers expressly
            ...
            duration to ninety (90) days from the date of first use.</Typography>

        <Typography>Some jurisdictions do not allow the exclusion of implied warranties, so the above exclusion may not apply
            to you.  Some jurisdictions do not allow limitations on how long an implied warranty lasts, so the above
            limitation may not apply to you.</Typography>

        <Typography variant="h5">Limitation on Liability</Typography>

        <Typography>To the maximum extent permitted by law, in no event shall company or our suppliers be liable to you or
            ...
            therefrom.</Typography>

        <Typography>To the maximum extent permitted by law, notwithstanding anything to the contrary contained herein, our
            ...
            this agreement.</Typography>

        <Typography>Some jurisdictions do not allow the limitation or exclusion of liability for incidental or consequential
            damages, so the above limitation or exclusion may not apply to you.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Term and Termination.</Typography> Subject to this Section, these Terms will remain in full force and
            effect while you use the Site.  We may suspend or terminate your rights to use the Site at any time for
            any reason at our sole discretion, including for any use of the Site in violation of these Terms.  Upon
            ...
            through 2.5, Section 3 and Sections 4 through 10.</Typography>

        <Typography variant="h5">Copyright Policy.</Typography>

        <Typography>Company respects the intellectual property of others and asks that users of our Site do the same.  In
        ...
        <ul>
            ...
            <li>identification of the material on our services that you claim is infringing and that you request us
                to remove;</li>
        ...
        <Typography>Please note that, pursuant to 17 U.S.C. § 512(f), any misrepresentation of material fact in a written
        ...
        <Typography>These Terms are subject to occasional revision, and if we make any substantial changes, we may notify you
            ...
            ACTION WAIVER.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Applicability of Arbitration Agreement.</Typography> All claims and disputes in connection with the
            ...
            authorized or unauthorized users or beneficiaries of services or goods provided under the Terms.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Notice Requirement and Informal Dispute Resolution.</Typography> Before either party may seek
            ...
            sent to: Kofas Tools. After the Notice is received, you and the Company may attempt to resolve the claim
            ...
            determined the amount of the award to which either party is entitled.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Arbitration Rules.</Typography> Arbitration shall be initiated through the American Arbitration
            ...
            of the fees and costs of the ADR Provider.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Additional Rules for Non-Appearance Based Arbitration.</Typography> If non-appearance based
            ...
            agreed by the parties.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Time Limits.</Typography> If you or the Company pursues arbitration, the arbitration action must be
            initiated and/or demanded within the statute of limitations and within any deadline imposed under the
            AAA Rules for the pertinent claim.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Authority of Arbitrator.</Typography> If arbitration is initiated, the arbitrator will decide the
            ...
            would have.  The award of the arbitrator is final and binding upon you and the Company.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Waiver of Jury Trial.</Typography> THE PARTIES HEREBY WAIVE THEIR CONSTITUTIONAL AND STATUTORY RIGHTS
        ...
        <Typography><Typography style={{fontSWeight: 'bold'}}>Waiver of Class or Consolidated Actions.</Typography> All claims and disputes within the scope of
            ...
            consolidated with those of any other customer or user.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Confidentiality.</Typography> All aspects of the arbitration proceeding shall be strictly
            ...
            enforce this Agreement, to enforce an arbitration award, or to seek injunctive or equitable relief.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Severability.</Typography> If any part or parts of this Arbitration Agreement are found under the law
            to be invalid or unenforceable by a court of competent jurisdiction, then such specific part or parts
            shall be of no force and effect and shall be severed and the remainder of the Agreement shall continue
            in full force and effect.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Right to Waive.</Typography> Any or all of the rights and limitations set forth in this Arbitration
            Agreement may be waived by the party against whom the claim is asserted.  Such waiver shall not waive or
            affect any other portion of this Arbitration Agreement.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Survival of Agreement.</Typography> This Arbitration Agreement will survive the termination of your
            relationship with Company.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Small Claims Court.</Typography> Nonetheless the foregoing, either you or the Company may bring an
            individual action in small claims court.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Emergency Equitable Relief.</Typography> Anyhow the foregoing, either party may seek emergency
            ...
            obligations under this Arbitration Agreement.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Claims Not Subject to Arbitration.</Typography> Notwithstanding the foregoing, claims of defamation,
            violation of the Computer Fraud and Abuse Act, and infringement or misappropriation of the other party’s
            patent, copyright, trademark or trade secrets shall not be subject to this Arbitration Agreement.</Typography>

        <Typography>In any circumstances where the foregoing Arbitration Agreement permits the parties to litigate in court,
            the parties hereby agree to submit to the personal jurisdiction of the courts located within Netherlands
            County, California, for such purposes.</Typography>

        <Typography>The Site may be subject to U.S. export control laws and may be subject to export or import regulations in
            ...
            States export laws or regulations.</Typography>

        <Typography>Company is located at the address in Section 10.8. If you are a California resident, you may report
            ...
            by telephone at (800) 952-5210.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Electronic Communications.</Typography> The communications between you and Company use electronic
            ...
            obligation that such communications would satisfy if it were be in a hard copy writing.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Entire Terms.</Typography> These Terms constitute the entire agreement between you and us regarding
            ...
            these Terms.  The terms and conditions set forth in these Terms shall be binding upon assignees.</Typography>

            </Typography><Typography style={{fontSWeight: 'bold'}}>Your Privacy.</Typography> Please read our <Link to={constants.PRIVACY}>Privacy
                Policy</Link>.</Typography>

        <Typography><Typography style={{fontSWeight: 'bold'}}>Copyright/Trademark Information.</Typography> Copyright ©. All rights reserved.  All trademarks,
        ...
        <Typography>Address: Kofas Tools</Typography>
        <Typography>Email: gabriesxp@gmail.com</Typography>
    </div>
    <Footer />
    </>
}