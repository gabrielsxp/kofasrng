        ...
        <Container>
            <Grid container className={classes.section}>
                <Grid item xs={12} md={4} className={classes.grid}>
                    ...
                    <Typography className={classes.title}>Server Status: {stats ? <span style={{ fontWeigth: 'bold', color: 'green' }}>Online</span> : <span style={{ fontWeigth: 'bold', color: 'red' }}>Offline</span>}</Typography>
                    <hr />
                    {
                        stats && !loading && <>
